...
const HeadingControls: React.FC<HeadingControlsProps> = ({ customization, onChange }) => {
    return (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex items-center gap-3">
                        <input
                            ...
                            onChange={e => onChange('headingTextColor', e.target.value)}
                ...
                <div className="flex flex-col">
                    ...
                    <input
                        ...
                        onChange={e => onChange('headingFontSize', parseInt(e.target.value))}
                        className="w-full border border-gray-200 rounded-lg px-3 py-2 focus:ring-2 focus:ring-fuchsia-400 focus:border-fuchsia-400 focus:outline-none bg-gray-50 hover:bg-white transition"
                    />
                </div>
                ...
                <div className="flex flex-col">
                    ...
                    <select
                        ...
                        onChange={e => onChange('headingFontWeight', parseInt(e.target.value))}
                        className="w-full border border-gray-200 rounded-lg px-3 py-2 focus:ring-2 focus:ring-fuchsia-400 focus:border-fuchsia-400 focus:outline-none bg-gray-50 hover:bg-white transition"
                    >
